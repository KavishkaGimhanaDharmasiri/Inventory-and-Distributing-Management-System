...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_SESSION['form_token']) || $formToken !== $_SESSION['form_token']) {
        // Invalid token, redirect to prevent form resubmission
...
unset($_SESSION['form_token']);
    ...
    // Generate and store a new form token for the session
