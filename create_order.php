...
try {
    ...
    $pdo->commit();
        echo '<div  style="top: 0;left: 0;width: 100%;height: 100%;backdrop-filter: blur(9px);z-index: 1;"></div><div id="successModal" style="position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);padding: 20px;background-color: white;color:#4CAF50 ;z-index: 1;border-radius: 15px;border: 2px solid #4CAF50;height: 150px;width: 200px;"><div class="gif" style="';echo"background: url('gif4.gif') no-repeat center center;";echo'margin-left: 25%;align-content: center;height: 95px;width: 95px;margin-bottom: 20px;"></div><button onclick="redirectToIManage()" class="sucess" style="width: 50px;padding: 10px;background-color: #4caf50;color: #fff;border: none;border-radius: 15px;cursor: pointer;width: calc(100% - 5px);margin-bottom: 5px;">OK</button></div>';
