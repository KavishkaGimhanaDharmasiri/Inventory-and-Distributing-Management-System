...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["add_order"])) {
    ...
    header("Location: new_new_order.php");
    exit();
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["confirm_order"])) {
    ...
    // Redirect after processing form submission
    header("Location: vm.php?main_category=$mainCategory&subcategories=$subcategories&counts=$counts");
    exit();
}
...
<body>
    ...
    <div class="order-form">
        <form method="POST" action="new_new_order.php">
