...
if (!empty($orderDetails)) {
    ...
    echo "<thead>";
    echo '<tr><th id="leftth" style="text-align:center;">Product</th><th>Unit Price</th><th>Count</th><th id="rightth">Subtotal</th></tr>';
    echo "</thead>";
   ...
   foreach ($orderDetails as $order) {
    ...
    $totalAmount += $subtotal;
        ...
        echo '<tr style="tr:hover{background: hsla(207, 88%, 23%, 1);
